/****************************************************************************
	...
	HISTORY:		07/24/98 [blg] This file was created
					...
					07/27/01 [mas] modified for AVP2

	COMMENT:		Copyright (c) 1998-2001, Monolith Productions Inc.
...
public:
	...
	LTBOOL				Init( char* sBuf, LTBOOL bMenu = LTFALSE);
	void				Term();
	void				Clear();
...
public:
	...
	LTBOOL				Init (int nMode = CM_CREDITS, LTBOOL bClearScreen = LTFALSE, LTBOOL bMenu = LTFALSE);
	...
	LTBOOL				IsLooping() { return(m_bLoop); }
