...
class CParticleExplosionFX : public CBaseParticleSystemFX
{
	...
	private :
        ...
        LTBOOL UpdateEmitter(MovingObject* pObject, int i);
...
class SFX_ParticleExplosionFactory : public CSpecialFXFactory
{
	SFX_ParticleExplosionFactory() : CSpecialFXFactory(SFX_PARTICLEEXPLOSION_ID) {;}
	static const SFX_ParticleExplosionFactory registerThis;
