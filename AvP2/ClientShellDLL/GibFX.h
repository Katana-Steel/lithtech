...
class CGibFX : public CSpecialFX
{
	...
	private :
		...
		uint8		m_nCharacterSet;				// Character set from Butes
...
class SFX_GIBFactory : public CSpecialFXFactory
{
	SFX_GIBFactory() : CSpecialFXFactory(SFX_GIB_ID) {;}
	static const SFX_GIBFactory registerThis;
