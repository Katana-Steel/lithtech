...
public:
	...
	void			SetNumericDisplay(LTBOOL bDisplay, LTBOOL bTextOnly = LTFALSE, CLTGUIFont *pFont = LTNULL);

	//this function sets up a notification when the control's value changes
	void			NotifyOnChange(uint32 dwCommandID, CLTGUICommandHandler *pCommandHandler, uint32 dwParam1 = 0, uint32 dwParam2 = 0);
