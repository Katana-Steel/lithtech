...
LTBOOL CParticleExplosionFX::UpdateEmitter(MovingObject* pObject, int i)
{
...
//-------------------------------------------------------------------------------------------------
// SFX_ParticleExplosionFactory
//-------------------------------------------------------------------------------------------------

const SFX_ParticleExplosionFactory SFX_ParticleExplosionFactory::registerThis;

CSpecialFX* SFX_ParticleExplosionFactory::MakeShape() const
{
	return new CParticleExplosionFX();
}
